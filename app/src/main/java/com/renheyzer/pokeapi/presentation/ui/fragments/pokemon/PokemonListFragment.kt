...
import com.renheyzer.core.base.BaseFragment
import com.renheyzer.core.extensions.navigateSafely
import com.renheyzer.core.utils.LayoutColumnUtil
import com.renheyzer.pokeapi.R
import com.renheyzer.pokeapi.databinding.FragmentPokemonListBinding
import com.renheyzer.pokeapi.databinding.ItemAttributesBinding
import com.renheyzer.pokeapi.presentation.ui.adapters.PokemonLoadStateAdapter
import com.renheyzer.pokeapi.presentation.ui.adapters.PokemonPagingAdapter
...
class PokemonListFragment : BaseFragment<FragmentPokemonListBinding, PokemonListViewModel>(
    ...
    private fun applyFilter(attack: Boolean, defense: Boolean, hp: Boolean) {
        if (attack && defense && hp) {
            ...
            lifecycleScope.launch {
                pokemonPagingAdapter.submitData(PagingData.from(
